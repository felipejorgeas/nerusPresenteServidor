...
$dados = sprintf("
  <dados>
    ...
    %s
        ...
        $pedido['lojaCodigo'], $pedido['pdvCodigo'], $pedido['pedidoCodigo'], date("Ymd"), 
        $pedido['funcionarioCodigo'], $pedido['usuarioCodigo'], 0, 1, 1, 
        $pedido['clienteListaCodigo'], $pedido['tipoListaCodigo'], $pedido['observacoes'], $produtos);
